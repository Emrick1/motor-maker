...
namespace Mechanix
{
     ...
     public class CarMovement : MonoBehaviour
    {
        ...
        void Update()
        {
            Quaternion deltaRotationLeft = Quaternion.Euler(new Vector3(0, 0.2f, 0) * Time.fixedDeltaTime);
            Quaternion deltaRotationRight = Quaternion.Euler(new Vector3(0, -0.2f, 0) * Time.fixedDeltaTime);
            setRbVector();
